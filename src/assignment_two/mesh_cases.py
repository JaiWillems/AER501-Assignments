...
class MeshCases:
    ...
    def one_element_per_node():
        ...
        node_3 = FrameNode(1, 0, harmonic_excitation_amplitude_y=1)
    ...
    def three_elements_per_node():
        ...
        node_4 = FrameNode(1, 0, harmonic_excitation_amplitude_y=1)
    ...
    def four_elements_per_node():
        ...
        node_5 = FrameNode(1, 0, harmonic_excitation_amplitude_y=1)
